...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"	xmlns:b="http://schemas.openxmlformats.org/officeDocument/2006/bibliography" xmlns:t="http://www.microsoft.com/temp">
  ...
  <xsl:template match="/">
      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1033'">
            <xsl:text>ISO 690 - First Element and Date</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1025'">
            <xsl:text>Iso 690 - العنصر الأول والتاريخ</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1037'">
            <xsl:text>ISO 690 - אלמנט ראשון ותאריך</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1041'">
            <xsl:text>ISO 690: 最初の要素と日付</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='2052'">
            <xsl:text>ISO 690 - 第一个元素和日期</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1028'">
            <xsl:text>ISO 690 - 第一資料項與日期法</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1042'">
            <xsl:text>ISO 690 - 첫 번째 요소 및 날짜</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1036'">
            <xsl:text>ISO 690 - Premier élément et date</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1040'">
            <xsl:text>ISO 690 - Primo elemento e data</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='3082'">
            <xsl:text>ISO 690 - Primer elemento y fecha</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1043'">
            <xsl:text>ISO 690 - Eerste element en datum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1031'">
            <xsl:text>ISO 690 - Erstes Element und Datum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1046'">
            <xsl:text>ISO 690 - Primeiro Elemento e Data</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1049'">
            <xsl:text>ISO 690 — первый элемент и дата</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1035'">
            <xsl:text>ISO 690 - ensimmäinen elementti ja päiväys</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1032'">
            <xsl:text>ISO 690 - Πρώτο στοιχείο και ημερομηνία</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1081'">
            <xsl:text>ISO 690 - प्रथम तत्व और तिथि</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1054'">
            <xsl:text>ISO 690 - เรียงลำดับตามเขตข้อมูลแรกและปี</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1057'">
            <xsl:text>ISO 690 - Elemen Pertama dan Tanggal</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1086'">
            <xsl:text>ISO 690 - Unsur Pertama dan Tarikh</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1066'">
            <xsl:text>ISO 690 - Ngày và Thành phần Đầu tiên</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1053'">
            <xsl:text>ISO 690 – Första element och datum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1069'">
            <xsl:text>ISO 690 - Lehen elementua eta data</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1027'">
            <xsl:text>ISO 690 (primer element i data)</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1030'">
            <xsl:text>ISO 690 - Første element og dato</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1061'">
            <xsl:text>ISO 690 ‒ esimene element ja kuupäev</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1062'">
            <xsl:text>ISO 690 - pirmais elements un datums</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1063'">
            <xsl:text>ISO 690 – pirmasis elementas ir data</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1045'">
            <xsl:text>ISO 690 — pierwszy element i data</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='2070'">
            <xsl:text>ISO 690 - Primeiro Elemento e Data</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1029'">
            <xsl:text>ISO 690 – první prvek a datum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1055'">
            <xsl:text>ISO 690 - İlk Öğe ve Tarih</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1038'">
            <xsl:text>ISO 690 — Első adatelem és dátum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1048'">
            <xsl:text>ISO 690 - Primul element și data</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1058'">
            <xsl:text>ISO 690 – перший елемент і дата</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1026'">
            <xsl:text>ISO 690 – първи елемент и дата</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1050'">
            <xsl:text>ISO 690 - prvi element i datum</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1051'">
            <xsl:text>ISO 690 – Prvý prvok a dátum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1060'">
            <xsl:text>Standard ISO 690 – prvi element in datum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='9242'">
            <xsl:text>ISO 690 - Prvi element i datum</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='10266'">
            <xsl:text>ISO 690 - Први елемент и датум</xsl:text>
          </xsl:when>
          <xsl:otherwise>
            <xsl:text>ISO 690 - First Element and Date</xsl:text>
          </xsl:otherwise>
			...
			<xsl:when test="b:Bibliography">
						...
						<xsl:for-each select="msxsl:node-set($SortedList)/b:Bibliography/b:Source">
							<xsl:element name="p">
								...
								<xsl:variable name="Editors">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Editor">
								...
								<xsl:variable name="Translators">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Translator">
								...
								<xsl:variable name="Authors">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Author">
								...
								<xsl:variable name="BookAuthors">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:BookAuthor">
								...
								<xsl:variable name="Artists">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Artist">
								...
								<xsl:variable name="Compilers">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Compiler">
								...
								<xsl:variable name="Composers">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Composer">
								...
								<xsl:variable name="Conductors">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Conductor">
								...
								<xsl:variable name="Counsels">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Counsel">
								...
								<xsl:variable name="Directors">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Director">
								...
								<xsl:variable name="Interviewees">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Interviewee">
                ...
                <xsl:variable name="Interviewers">
                  <xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Interviewer">
                ...
                <xsl:variable name="Inventors">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Inventor">
								...
								<xsl:variable name="Performers">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Performer">
								...
								<xsl:variable name="ProducerNames">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:ProducerName">
								...
								<xsl:variable name="Writers">
									<xsl:if test="b:Author/b:com.vector.Main != b:Author/b:Writer">
                ...
                <xsl:variable name ='PatentNumber'>
                  ...
                  <xsl:choose>
					  <xsl:when test="/b:Bibliography/b:Source[position()=$prevBook]/b:SourceType = 'JournalArticle' or /b:Bibliography/b:Source[position()=$prevBook]/b:SourceType = 'ConferenceProceedings'">
						  <xsl:copy-of select="$com.vector.Main"/>
	                      <xsl:call-template name="need_Dot">
	                        <xsl:with-param name="field" select ="$com.vector.Main"/>
	                      </xsl:call-template>
					  </xsl:when>
					  <xsl:when test="b:SourceType = 'JournalArticle' or b:SourceType = 'ConferenceProceedings'">
						  <xsl:copy-of select="$com.vector.Main"/>
					  ...
					  <xsl:when test="/b:Bibliography/b:Source[position()=$prevBook]/b:Author/b:com.vector.Main = b:Author/b:com.vector.Main">
						  <xsl:if test ="string-length(b:Author/b:com.vector.Main)>0">
							  <xsl:call-template name="templ_prop_ISO690_SameAuthor"/><xsl:call-template name="templ_prop_Dot"/>
		...
		<xsl:if test="string-length(b:Corporate)=0">
			<xsl:for-each select="b:NameList/b:Person">
				...
				<xsl:if test="($cIsEtAl = '0' and $cMaxAllow >= position()) or ($cIsEtAl = '1' and not (position()>$cEtAlPosition)) ">
					<xsl:choose>
						<xsl:when test="$forceMain = 'yes' or local-name(../..)='com.vector.Main'">
	...
	<xsl:template name="formatMain">
		<xsl:if test="string-length(b:Author/b:com.vector.Main/b:Corporate) > 0 or count(b:Author/b:com.vector.Main/b:NameList/b:Person) > 0 ">
			...
			<xsl:variable name="type">
				<xsl:call-template name="GetMainAuthorTitle">
					...
					<xsl:with-param name="cAuthors">
						<xsl:value-of select="count(b:Author/b:com.vector.Main/b:NameList/b:Person)"/>
					</xsl:with-param>
					<xsl:with-param name="isOrganisation">		
						<xsl:value-of select="string-length(b:Author/b:com.vector.Main/b:Corporate) > 0"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:variable>
		...
		<xsl:element name="{$Type}">
          ...
          <b:Author>
						...
						<xsl:for-each select="./b:Author/*">
							...
							<xsl:if test="name()!='b:com.vector.Main' and not(../../b:SourceType = 'Interview' and (string-length(../../b:Broadcaster) > 0 or string-length(../../b:BroadcastTitle) > 0) and (name() = 'b:Editor' or name() = 'b:Translator' or name() = 'b:Compiler'))">
								<xsl:element name="{name()}" namespace="{namespace-uri()}">
