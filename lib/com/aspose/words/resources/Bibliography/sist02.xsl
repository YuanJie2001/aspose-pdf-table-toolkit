...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"	xmlns:b="http://schemas.openxmlformats.org/officeDocument/2006/bibliography" xmlns:t="http://www.microsoft.com/temp">
  ...
  <xsl:template name="templ_prop_SIST_DateAccessed_DY" >
      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1087'">
            <xsl:text>Жапония білім және технология агенттігінің білім және технология ақпаратын алуға арналған стандарттары</xsl:text>
          </xsl:when>
      ...
      <xsl:when test="b:GetImportantFields">
			...
			<xsl:when test="b:Bibliography">
                ...
                <xsl:variable name ="InternetSiteTitle">
                  ...
                  <xsl:call-template name="templ_prop_SIST_GeneralOpen"/>
                  <xsl:call-template name="templ_str_OnlineCap"/>
                  <xsl:call-template name="templ_prop_SIST_GeneralClose"/>
                  <xsl:call-template name="templ_prop_Space"/>
                </xsl:variable>
                ...
                <xsl:variable name ='Medium'>
									<xsl:if test="string-length(b:Medium)>0">
										...
										<xsl:call-template name="templ_prop_SIST_GeneralClose"/><xsl:call-template name="templ_prop_Space"/>
                ...
                <b>
                  <xsl:choose>
					  ...
					  <xsl:if test ="string-length(b:Author/b:com.vector.Main)>0">
						  <xsl:call-template name="templ_prop_SIST_SameAuthor"/><xsl:call-template name="templ_prop_Dot"/>
	...
	<xsl:template name="formatLastFirst">
		<xsl:call-template name="formatNameCore">
			<xsl:with-param name="FML"><xsl:call-template name="templ_prop_SIST_MainAuthors_FML"/></xsl:with-param>
			<xsl:with-param name="FM"><xsl:call-template name="templ_prop_SIST_MainAuthors_FM"/></xsl:with-param>
			<xsl:with-param name="ML"><xsl:call-template name="templ_prop_SIST_MainAuthors_ML"/></xsl:with-param>
			<xsl:with-param name="FL"><xsl:call-template name="templ_prop_SIST_MainAuthors_FL"/></xsl:with-param>
	...
	<xsl:template name="formatFirstLast">
		<xsl:call-template name="formatNameCore">
			<xsl:with-param name="FML"><xsl:call-template name="templ_prop_SIST_SecondaryAuthors_FML"/></xsl:with-param>
			<xsl:with-param name="FM"><xsl:call-template name="templ_prop_SIST_SecondaryAuthors_FM"/></xsl:with-param>
			<xsl:with-param name="ML"><xsl:call-template name="templ_prop_SIST_SecondaryAuthors_ML"/></xsl:with-param>
			<xsl:with-param name="FL"><xsl:call-template name="templ_prop_SIST_SecondaryAuthors_FL"/></xsl:with-param>
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="formatPersonSeparator">
		...
		<xsl:choose>
			...
			<xsl:when test="$cMaxAllow > position()">
	...
	<xsl:template name="formatCompiler">
		<xsl:if test="string-length(b:Author/b:Compiler)>0">
			...
			<xsl:call-template name="templ_str_CompilerShortUnCapIso"/>
  ...
  <xsl:template name="formatInventor">
		<xsl:if test="string-length(b:Author/b:Inventor)>0">
			...
			<xsl:call-template name="templ_str_InventorShortUnCap"/>
	...
	<xsl:template name="formatDayMonthYear">
      ...
      <xsl:call-template name="formatDateCore">
				...
				<xsl:with-param name="DMY"><xsl:call-template name="templ_prop_SIST_Date_DMY"/></xsl:with-param>
				<xsl:with-param name="DM"><xsl:call-template name="templ_prop_SIST_Date_DM"/></xsl:with-param>
				<xsl:with-param name="MY"><xsl:call-template name="templ_prop_SIST_Date_MY"/></xsl:with-param>
				<xsl:with-param name="DY"><xsl:call-template name="templ_prop_SIST_Date_DY"/></xsl:with-param>
			</xsl:call-template>
		</xsl:if>
	</xsl:template>
      ...
      <xsl:variable name="date">
        <xsl:call-template name="formatDateCore">
          ...
          <xsl:with-param name="DMY">
            <xsl:call-template name="templ_prop_SIST_DateAccessed_DMY"/>
          </xsl:with-param>
          <xsl:with-param name="DM">
            <xsl:call-template name="templ_prop_SIST_DateAccessed_DM"/>
          </xsl:with-param>
          <xsl:with-param name="MY">
            <xsl:call-template name="templ_prop_SIST_DateAccessed_MY"/>
          </xsl:with-param>
          <xsl:with-param name="DY">
            <xsl:call-template name="templ_prop_SIST_DateAccessed_DY"/>
          </xsl:with-param>
        </xsl:call-template>
      </xsl:variable>
